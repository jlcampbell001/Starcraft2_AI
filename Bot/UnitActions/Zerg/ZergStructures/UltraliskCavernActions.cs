...
{
    class UltraliskCavernActions : ZergStructureActions
    {
        public UltraliskCavernActions(ZergController controller) : base(controller)
        {
            unitType = Units.ULTRALISK_CAVERN;
        }
