...
namespace Bot
{
    public class GameConnection
    {
        ...
        private async Task CreateGame(string mapName, Race opponentRace, Difficulty opponentDifficulty, Boolean realTime = false)
        {
        ...
        private async Task Run(Bot bot, uint playerId)
        {
            ...
            ControllerDefault.GameInfo = gameInfoResponse.GameInfo;
            ControllerDefault.GameData = dataResponse.Data;
            ...
            while (true)
            {
                ...
                ControllerDefault.Obs = observation;
        ...
        public async Task RunSinglePlayer(Bot bot, string map, Race myRace, Race opponentRace,
            Difficulty opponentDifficulty, Boolean realTime = false)
        {
            var port = 5678;
