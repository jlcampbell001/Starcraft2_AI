...
namespace Bot
{
    internal static class Units
    {
        ...
        public static readonly HashSet<uint> GasGeysersStructures = new HashSet<uint> {
            EXTRACTOR,
            ASSIMILATOR,
            REFINERY
        };
        ...
        public static readonly HashSet<uint> NeedLairOrHive = new HashSet<uint>
        {
            HYDRALISK_DEN,
            SPIRE,
            NYDUS_NETWORK,
        ...
        public static readonly HashSet<uint> NeedHive = new HashSet<uint>
        {
            VIPER,
            ULTRALISK_CAVERN
        };

        public static readonly HashSet<uint> NeedSpawningPool = new HashSet<uint> {
            ZERGLING,
            SPORE_CRAWLER,
            SPINE_CRAWLER,
            LAIR,
        ...
        public static readonly HashSet<uint> NeedHydraliskDen = new HashSet<uint> {
            HYDRALISK,
            LURKER_DEN
        };

        public static readonly HashSet<uint> NeedRoachWarren = new HashSet<uint> {
            ROACH
        };
        ...
        public static readonly HashSet<uint> NeedLurkerDen = new HashSet<uint> {
            LURKER
        };

        public static readonly HashSet<uint> NeedUltraliskCavern = new HashSet<uint> {
            ULTRALISK
        };

        public static readonly HashSet<uint> IncludesDroneCost = new HashSet<uint> {
            HATCHERY,
            SPAWNING_POOL,
            ROACH_WARREN,
            SPORE_CRAWLER,
